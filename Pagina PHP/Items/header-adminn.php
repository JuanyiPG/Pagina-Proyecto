 <aside class="sidebar">
    ...
    <ul class="submenu" id="submenuForm">
        <li><a href="../PHP/ROL/INDEX_ROL.php" class="sidebar_hide_a">Rol</a></li>
        <li><a href="../PHP/CLIENTE/INDEX_CLIENTE.php" class="sidebar_hide_a">Cliente</a></li>
        <li><a href="../PHP/EMPLEADO/INDEX_EMPLEADO.php" class="sidebar_hide_a">Empleado</a></li>
        <li><a href="../PHP/FACTURA_COMPRA/INDEX_FACTURAC.php" class="sidebar_hide_a">Factura Compra</a></li>
        <li><a href="../PHP/FACTURA_VENTA/INDEX_FACTURAV.php" class="sidebar_hide_a">Factura Venta</a></li>
        <li><a href="../PHP/MATERIA_PRIMA/INDEX_MATERIAP.php" class="sidebar_hide_a">Materia Prima</a></li>
        <li><a href="../PHP/PEDIDO/INDEX_PEDIDO.php" class="sidebar_hide_a">Pedidos</a></li>
        <li><a href="../PHP/PRODUCCION/INDEX_PRODUCCION.php" class="sidebar_hide_a">Producción</a></li>
        <li><a href="../PHP/PRODUCTO_TERMINADO/INDEX_PRODUCTOT.php" class="sidebar_hide_a">Productos Terminados</a></li>
    </ul>
