<header class="navbar-cliente" id="header-cliente">
  <nav>
    <div class="menu">
      <!-- Izquierda -->
      <div class="menu-l">
        ...
        <button id="btnHamburguesa" class="btn btn-link p-0 border-0">
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" 
            ...
            <path fill-rule="evenodd" 
              d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5m0-4a.5.5 
              0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5m0-4a.5.5 
      ...
      <div class="menu-r">
        ...
        <a href="#">
          <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" 
            ...
            <path fill-rule="evenodd" 
              d="M10.5 3.5a2.5 2.5 0 0 0-5 0V4h5zm1 
              0V4H15v10a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V4h3.5v-.5a3.5 
              3.5 0 1 1 7 0M14 14V5H2v9a1 1 0 0 0 1 
              1h10a1 1 0 0 0 1-1M8 7.993c1.664-1.711 
              5.825 1.283 0 5.132-5.825-3.85-1.664-6.843 
              0-5.132"/>
          </svg>
        </a>
